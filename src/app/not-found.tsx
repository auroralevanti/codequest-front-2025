...
export default function NotFound() {
  return (
    <div className="flex bg-darker-purple w-full min-h-screen items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute left-0 bottom-60 md:relative md:left-auto md:bottom-auto ">
        <Image
          src={devi.src}
          alt='Devi'
          width={devi.width}
      ...
      <div className="right-8 top-70 max-w-md bg-gray-100 rounded-2xl p-8 shadow-xl z-30 md:relative md:right-auto md:top-auto md:-ml-20 sm:">
